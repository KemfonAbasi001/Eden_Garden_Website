...
//         className="w-full py-50 sm:py-24 md:py-28 lg:py-25 flex items-center justify-center flex-col text-center gap-4 sm:gap-5 bg-cover bg-center bg-no-repeat"
//       >
//         <p
...
//         >
//           <a href="/Compo" className="uppercase border border-solid font-medium text-[#FFFFFF] text-[11px] sm:text-[12px] leading-4 tracking-[3px] sm:tracking-[3.6px] border-[#ffffff4d] py-3.5 sm:py-4 px-13 sm:px-10 transition-all duration-500 ease-in-out hover:bg-white hover:text-black">
//             Explore garden
//           </a>
...
//           style={{ transitionDelay: "320ms" }}
//         >
//           <a href="" className="uppercase font-medium border border-solid bg-[#FFFFFF] text-[#1C221F] text-[11px] sm:text-[12px] leading-4 tracking-[3px] sm:tracking-[3.6px] py-3 sm:py-4 px-12 sm:px-10">
//             Reserve your visit
//           </a>
...
function HomeSection() {
  ...
  // Scroll to top if already on home page (used by logo + home nav link)
  ...
  return (
    <>
      ...
      {/* Hero — id lets "Book a Visit" / "Reserve" / "Host" scroll here */}
      <section
        id="home"
        ref={heroRef}
        style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.6)), url(${bg_image})` }}
      ...
      >
        ...
        <div
          ...
          style={{ transitionDelay: "320ms" }}
        >
          {/* Explore Garden → Gallery section */}
          <a
            href="#gallery"
          ...
          {/* Book a Visit → scroll to top of page */}
          <a
            href="#home"
      ...
      <section id="collections" className="w-full py-16 sm:py-24 md:py-28 lg:py-35 flex justify-center items-center">
        <div className="w-[95%] flex flex-col justify-center items-center gap-14 sm:gap-18 lg:gap-22">
          ...
          {/* Garden Collection cards → /collections route */}
          <div ref={collectionsGridRef} className="w-full grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 lg:gap-7">
      ...
      {/* Living Art — id="gallery" so "Explore Garden" scrolls here */}
      <section id="gallery" className="w-full py-16 sm:py-24 md:py-28 lg:py-35 flex justify-center items-center">
        <div className="w-[95%] flex flex-col justify-center items-center gap-12 sm:gap-14 lg:gap-16">
          ...
          {/* Living Art cards → /gallery route */}
          <div ref={artGridRef} className="w-full grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
      ...
      >
        ...
        <div
          ...
          style={{ transitionDelay: "320ms" }}
        >
          {/* Reserve your visit → scroll to top */}
          <a
            href="#home"
            onClick={(e) => handleAnchorScroll(e, 'home')}
