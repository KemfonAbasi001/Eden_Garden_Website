...
//                 <div className="text-center flex flex-col gap-13 w-full">
//                     <div className="header text-center flex flex-col gap-6 w-full">
//                         <p className="font-medium text-[12px] leading-4 uppercase tracking-[4.8px] text-[#6D7873]  font-inter">Botanical Masterpieces</p>
//                         <h1 className="text-[96px] leading-24 font-normal tracking-[4.8px] text-[#1C221F] font-cormorant">Flower <span className="italic">Gallery</span></h1>
//                     </div>

//                     <div className="w-full grid grid-cols-3 gap-7.5">
                        
//                         <div className="relative w-full">
//                             <img src={pics} alt="1" />
//                             <div className="absolute bottom-9 left-8   flex flex-col gap-2">
//                                 <h1 className="text-[24px] leading-8 font-medium tracking-[1.2px] text-[#FFFFFF] font-cormorant">Royal Orchid</h1>
//                             </div>
//                         </div>

//                         <div className="relative w-full">
//                             <img src={picsOne} alt="1" />
//                             <div className="absolute bottom-9 left-8   flex flex-col gap-2">
//                                 <h1 className="text-[24px] leading-8 font-medium tracking-[1.2px] text-[#FFFFFF] font-cormorant">Sacred Lotus</h1>
//                             </div>
//                         </div>

//                         <div className="relative w-full">
//                             <img src={picsTwo} alt="1" />
//                             <div className="absolute bottom-9 left-8   flex flex-col gap-2">
//                                 <h1 className="text-[24px] leading-8 font-medium tracking-[1.2px] text-[#FFFFFF] font-cormorant">Heritage Rose</h1>
//                             </div>
//                         </div>

//                         <div className="relative w-full">
//                             <img src={picsThree} alt="1" />
//                             <div className="absolute bottom-9 left-8   flex flex-col gap-2">
//                                 <h1 className="text-[24px] leading-8 font-medium tracking-[1.2px] text-[#FFFFFF] font-cormorant">White Lily</h1>
//                             </div>
//                         </div>
...
//                             <img src={picsT} alt="1" />
//                             <div className="absolute bottom-9 left-8   flex flex-col gap-2">
//                                 <h1 className="text-[24px] leading-8 font-medium tracking-[1.2px] text-[#FFFFFF] font-cormorant">Bird of Paradise</h1>
//                             </div>
//                         </div>

//                         <div className="relative w-full">
//                             <img src={imgTen} alt="1" />
//                             <div className="absolute bottom-9 left-8   flex flex-col gap-2">
//                                 <h1 className="text-[24px] leading-8 font-medium tracking-[1.2px] text-[#FFFFFF] font-cormorant">Green Cascade</h1>
//                             </div>
//                         </div>
