      ...
      <section className="w-full py-35 sm:py-24 md:py-28 lg:py-35 flex justify-center items-center">
        <div className="w-[93%] flex flex-col justify-center items-center gap-14 sm:gap-18 lg:gap-22">
          ...
          <div className="w-full flex flex-col gap-10 sm:gap-12 lg:gap-15">
            ...
            <div
              ref={heroRef}
              className={`w-full relative h-84 sm:h-96 md:h-120 lg:h-127.5 overflow-hidden ${base} ${heroVisible ? show : hidden}`}
              style={{ transitionDelay: "0ms" }}
            >
              <img
                src={imgOne}
              ...
              <div className="absolute bottom-6 left-6 sm:bottom-10 sm:left-10 lg:bottom-17 lg:left-15 max-w-[90%] sm:max-w-130 lg:max-w-146 flex flex-col gap-3 sm:gap-4">
